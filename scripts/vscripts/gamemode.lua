...
function GameMode:InitGameMode()
  ...
  Convars:RegisterCommand( "command_example", Dynamic_Wrap(GameMode, 'ExampleConsoleCommand'), "A console command example", FCVAR_CHEAT )
	...
	--holding player data for future use
	self.players = {}
	
	--holding unit selected data
	self.playerUnitSelected = {}
	
	--holding unitData for potential unit cap
	self.unitCount = {}
	
	--setting up player counter for units on the mid trigger and side triggers
	self.unitsCenter = {}
	...
	--holding teamNumbers for later date
	self.teamNumbers = {}
